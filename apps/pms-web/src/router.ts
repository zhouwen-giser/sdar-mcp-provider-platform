...
export const APP_ROUTES: readonly AppRoute[] = [
  ...
  route("/resources/:environment/:resourceId", "Resource 详情", "发现与资源", "P0"),
  route("/resources/:environment/:resourceId/history", "Resource History", "发现与资源", "P1"),
  route("/resources/:environment/:resourceId/activity", "Resource Activity", "发现与资源", "P1"),
