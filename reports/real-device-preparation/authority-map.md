...
| Task acceptance, task state, command sequencing, scheduler, recovery and `/mcp`           | MCP Tasks Runtime             | Runtime readiness, `tools/list`, `tools/call`, `tasks/get`, `tasks/result`, notification and PostgreSQL evidence |
